...
def write_ball_detections_csv(rows: list[dict], csv_path: str | Path) -> None:
    """Write ball detection rows to a CSV file with a stable header."""
    _write_csv(rows, csv_path, BALL_DETECTION_CSV_COLUMNS)
